    ...
    this.moving = {
      ...
      getDistance: function(){
        ...
        for(var x=1;x<this.waypoints.length;x++) {
          distance = parseFloat(distance) + parseFloat(calculateDistance(this.waypoints[x-1].position.coords.latitude, this.waypoints[x-1].position.coords.longitude, this.waypoints[x].position.coords.latitude, this.waypoints[x].position.coords.longitude));
        }
        return distance;
      }
    };
